...
//RLAPI void InitWindow2(int width, int height, const char *title);  // Initialize window and OpenGL context
void InitWindow2(int width, int height, const char *title);  // Initialize window and OpenGL context

//RLAPI bool WindowShouldClose(void);                               // Check if KEY_ESCAPE pressed or Close icon pressed
//RLAPI void CloseWindow2(void);                                     // Close window and unload OpenGL context
void CloseWindow2(void);                                     // Close window and unload OpenGL context
...
RLAPI void SetWindowPosition2(int x, int y);                       // Set window position on screen (only PLATFORM_DESKTOP)
RLAPI void SetWindowMonitor(int monitor);                         // Set monitor for the current window (fullscreen mode)
RLAPI void SetWindowMinSize(int width, int height);               // Set window minimum dimensions (for FLAG_WINDOW_RESIZABLE)
RLAPI void SetWindowSize2(int width, int height);                  // Set window dimensions
...
RLAPI void ClearBackground2(Color color);                          // Set background color (framebuffer clear color)
RLAPI void BeginDrawing2(void);                                    // Setup canvas (framebuffer) to start drawing
RLAPI void EndDrawing2(void);                                      // End canvas drawing and swap buffers (double buffering)
